                      ...
                      children: [
                        ...
                        Column(
                          children: [
                            ...
                            Text("\u{20B9}" + ds["Total"], style: AppWidget.boldTextFieldStyle(),)
                          ],
                        )
                      ],
                    ),
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text("\u{20B9}" + total.toString(), style: AppWidget.semiBoldTextFieldStyle(),)
                ],
              ),
            ),
            SizedBox(height: 20.0),
            GestureDetector(
              ...
              child: Container(
                ...
                child: Center(child: Text("ChechOut", style: TextStyle(color: Colors.white, fontSize: 20.0, fontWeight: FontWeight.bold),)),
              ),
            )
          ],
        ),
