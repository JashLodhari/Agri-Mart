...
class _SignUpState extends State<SignUp> {
  ...
  TextEditingController depLoccontroller = new TextEditingController();
    ...
    if(password!=null) {
      try {
        ...
        if(e.code == 'weak-password') {
          ...
          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
              backgroundColor: Colors.orangeAccent,
              content: Text("Account already exits", style: TextStyle(fontSize: 18.0),)));
        }
      }
    }
  }
          ...
          child: Stack(
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    Center(child: Image.asset("images/filename (1).png", width: MediaQuery.of(context).size.width/1, fit: BoxFit.cover,)),
                          ...
                          child: Column(
                            children: [
                              ...
                              TextFormField(
                                ...
                                decoration: InputDecoration(hintText: 'Department Location', hintStyle: AppWidget.semiBoldTextFieldStyle(), prefixIcon: Icon(Icons.location_city_outlined)),
                              ),
                              SizedBox(height: 30.0),
                              TextFormField(
                                ...
                                decoration: InputDecoration(hintText: 'Building Name', hintStyle: AppWidget.semiBoldTextFieldStyle(), prefixIcon: Icon(Icons.location_city_sharp)),
                              ),
                              SizedBox(height: 30.0),
                              TextFormField(
                                ...
                                decoration: InputDecoration(hintText: 'Mobile No.', hintStyle: AppWidget.semiBoldTextFieldStyle(), prefixIcon: Icon(Icons.phone_android_outlined)),
                              ),
